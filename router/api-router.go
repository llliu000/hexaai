	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.PUT("/:id/model_discounts", controller.UpdateUserModelDiscounts)
				adminRoute.PUT("/:id/seedance_channel", controller.UpdateUserSeedanceChannel)
		...
		logRoute.GET("/export", middleware.AdminAuth(), controller.ExportLogsExcel)
