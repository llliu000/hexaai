...
import UserModelDiscountsModal from './modals/UserModelDiscountsModal';
...
const UsersTable = (usersData) => {
  ...
  const [showUserSubscriptionsModal, setShowUserSubscriptionsModal] =
    useState(false);
  const [showModelDiscountsModal, setShowModelDiscountsModal] =
    useState(false);
  ...
  const showModelDiscountsUserModal = (user) => {
    setModalUser(user);
    setShowModelDiscountsModal(true);
  };
  ...
  const columns = useMemo(() => {
    return getUsersColumns({
      ...
      showModelDiscountsModal: showModelDiscountsUserModal,
    });
  }, [
    t,
    setEditingUser,
  ...
  return (
    <>
      ...
      <UserModelDiscountsModal
        visible={showModelDiscountsModal}
        onCancel={() => setShowModelDiscountsModal(false)}
        user={modalUser}
        t={t}
        onSuccess={() => refresh?.()}
      />
